...
readTextFile("ucsd_admissions.json", function(text){
    ...
    for(var year in data){
        ...
        curr_fulltime_women_admitted.push(parseInt(data[year]["fulltime_women_admitted"]));
        curr_fulltime_men_enrolled.push(parseInt(data[year]["fulltime_men_enrolled"]));
        curr_fulltime_women_enrolled.push(parseInt(data[year]["fulltime_women_enrolled"]));
    ...
    console.log(curr_fulltime_women_app);
